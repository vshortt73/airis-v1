...
def save_message(session_id: str, role: str, message: str, tool_calls=None, tool_call_id=None, tool_name=None, attachments=None) -> bool:
    """
    ...
    try:
        ...
        """, (role, message, datetime.now(), session_id, '3.0', tool_calls_json, tool_call_id, tool_name, attachments_json))
...
def load_recent_conversation(
    ...
    print(f"[persistence.py][load_recent_conversation] pulling max turns of {max_turns}")
    ...
    try:
        ...
        for row in all_messages:
            role, content, tool_calls, tool_call_id, tool_name, temporal_description, attachments_json, emotion_bias, display_priority = row
            ...
            if role == "assistant" and tool_calls:
                ...
                # PostgreSQL JSONB is automatically deserialized to dict/list by psycopg2
            elif role == "tool":
                if tool_name:
            ...
            if attachments_json:
                msg["attachments"] = attachments_json  # Store as JSON string for now
