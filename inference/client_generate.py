...
async def chat_completion_with_tools(
    ...
    print(f"[client.py][chat_completion_with_tools] querying Ollama at {config.OLLAMA_BASE_URL}/api/generate")
...
async def chat_completion_stream(
    ...
    print(f"[client.py][chat_completion_stream] querying Ollama at {config.OLLAMA_BASE_URL}/api/generate")
    async with httpx.AsyncClient(timeout=600.0) as client:
...
async def chat_completion_stream_with_tools(
    ...
    print(f"[client.py][chat_completion_stream_with_tools] Streaming from {config.OLLAMA_BASE_URL}/api/generate")
...
async def chat_completions(
    ...
    print(f"[client.py][chat_completions] querying Ollama at {config.OLLAMA_BASE_URL}/api/generate")
